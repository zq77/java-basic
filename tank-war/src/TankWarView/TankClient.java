...
//创建一个键盘事件，每当按一下指定的键，上面的线程开始重画就会发生变化
	...
	private void add() {			//添加敌对tank	
		...
		int inittankcount = Integer.parseInt(pros.getProperty("inittankcount"));
				
		for(int i=0; i<inittankcount; i++) {			//声名10量敌对坦克
